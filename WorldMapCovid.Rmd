...
```{r}
content <- paste("<strong>", WorldMapCovid$name, "</strong>", "<br/>", WorldMapCovid$CumulConfirmes, "Cas", "<br/>", WorldMapCovid$CumulMorts, "Décés", "<br/>", WorldMapCovid$CumulSoignes, "Soignés")
...
leaflet(WorldMapCovid) %>% 
  ...
  addCircleMarkers(radius = ~sqrt(category3)*5, popup = content,
    color = "green",
    stroke = FALSE, fillOpacity = 1) %>% 
  addCircleMarkers(radius = ~sqrt(category2)*5, popup = content,
    color = "red",
    stroke = FALSE, fillOpacity = 1)
```
